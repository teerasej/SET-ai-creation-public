# Module 3: Copilot Studio Core Build

หน้านี้เป็นสารบัญของแบบฝึกหัดทั้งหมดใน Module 3 สำหรับผู้เรียน SET employee AI Champion bootcamp
...
เมื่อจบ Module 3 แล้ว ให้ไปต่อที่ Module 4:

- [Module 4 - exercise-1-hybrid-topic-with-generative](../module-4/exercise-1-hybrid-topic-with-generative/README.md)